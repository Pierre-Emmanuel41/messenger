...
public interface IProtocolConfiguration {
	...
	/**
	 * Parse the given bytes array. The input array shall have the following format:<br>
	 * <p>
	 ...
	 * @return The message corresponding to the content of the bytes array, null if the protocol version is not supported or if the
	 *         message identifier is not supported for the protocol version.
	 */
