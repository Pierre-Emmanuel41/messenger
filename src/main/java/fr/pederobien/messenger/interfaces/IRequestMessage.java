...
public interface IRequestMessage {
	...
	/**
	 * @return The callback to execute once a response has been received from the remote.
	 */
	Consumer<CallbackArgs> getCallback();

	/**
	 * Set the request callback to execute once a response has been received from the server. The timeout value is 1000ms.
	 *
	...
	/**
	 * Set the request callback to execute once a response has been received from the server.
	 *
